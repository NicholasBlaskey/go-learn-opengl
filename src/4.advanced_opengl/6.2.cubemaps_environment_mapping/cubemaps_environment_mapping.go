// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/4.advanced_opengl/6.2.cubemaps_environment_mapping/cubemaps_environment_mapping.cpp
...
func main() {
	...
	ourShader := shader.MakeShaders("6.2.cubemaps.vs", "6.2.cubemaps.fs")
	skyboxShader := shader.MakeShaders("6.2.skybox.vs", "6.2.skybox.fs")
