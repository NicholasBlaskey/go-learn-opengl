// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/4.advanced_opengl/9.2.geometry_shader_exploding/geometry_shader_exploding.cpp
...
func main() {
	...
	for !window.ShouldClose() {
		...
		// Add time component to geo shader
		ourShader.SetFloat("time", float32(glfw.GetTime()))
