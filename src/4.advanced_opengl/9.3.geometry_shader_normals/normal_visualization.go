// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/4.advanced_opengl/9.3.geometry_shader_normals/normal_visualization.cpp
...
func main() {
	...
	ourShader := shader.MakeShaders("9.3.default.vs", "9.3.default.fs")
