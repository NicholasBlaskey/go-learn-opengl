// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/5.advanced_lighting/4.normal_mapping/normal_mapping.cpp
...
func main() {
	...
	ourShader := shader.MakeShaders("4.normal_mapping.vs", "4.normal_mapping.fs")

	dir := "../../../resources/textures"
	diffuseMap := loadModel.TextureFromFile("brickwall.jpg", dir, false)
	normalMap := loadModel.TextureFromFile("brickwall_normal.jpg", dir, false)
