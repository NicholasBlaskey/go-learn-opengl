// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/5.advanced_lighting/5.3.parallax_occlusion_mapping/parallax_occlusion_mapping.cpp
...
func main() {
	...
	ourShader := shader.MakeShaders("5.3.parallax_mapping.vs", "5.3.parallax_mapping.fs")
	...
	/*
		diffuseMap := loadModel.TextureFromFile("toy_box_diffuse.png", dir, false)
		normalMap := loadModel.TextureFromFile("toy_box_normal.png", dir, false)
		heightMap := loadModel.TextureFromFile("toy_box_disp.png", dir, false)
	*/
	ourShader.Use()
