// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/2.lighting/5.3.light_casters_spot/light_casters_spot.cpp
...
func main() {
	...
	lightingShader := shader.MakeShaders("5.3.light_casters.vs",
		"5.3.light_casters.fs")
	lampShader := shader.MakeShaders("5.3.lamp.vs", "5.3.lamp.fs")
