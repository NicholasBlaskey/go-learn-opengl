// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/tree/master/src/2.lighting/2.2.basic_lighting_specular
...
func main() {
	...
	lightingShader := shader.MakeShaders("2.2.basic_lighting.vs",
		"2.2.basic_lighting.fs")
	lampShader := shader.MakeShaders("2.2.lamp.vs", "2.2.lamp.fs")
