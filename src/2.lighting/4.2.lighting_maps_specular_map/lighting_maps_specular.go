// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/2.lighting/4.2.lighting_maps_specular_map/lighting_maps_specular.cpp
...
func main() {
	...
	lightingShader := shader.MakeShaders("4.2.lighting_maps.vs",
		"4.2.lighting_maps.fs")
	lampShader := shader.MakeShaders("4.2.lamp.vs", "4.2.lamp.fs")
