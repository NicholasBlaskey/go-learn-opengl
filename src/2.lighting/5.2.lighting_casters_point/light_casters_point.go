// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/2.lighting/5.2.light_casters_point/light_casters_point.cpp
...
func main() {
	...
	lightingShader := shader.MakeShaders("5.2.light_casters.vs",
		"5.2.light_casters.fs")
	lampShader := shader.MakeShaders("5.2.lamp.vs", "5.2.lamp.fs")
