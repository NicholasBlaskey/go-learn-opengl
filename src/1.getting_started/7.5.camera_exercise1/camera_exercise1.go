// Translated from
// https://learnopengl.com/code_viewer.php?code=getting-started/camera-exercise1
package main
...
func main() {
	...
	ourShader := shader.MakeShaders("7.5.camera.vs", "7.5.camera.fs")
...
func keyCallback(window *glfw.Window, key glfw.Key, scancode int,
	...
	// One liner to make us stay on the floor like a fps camera
	ourCamera.Position[1] = 0
}
