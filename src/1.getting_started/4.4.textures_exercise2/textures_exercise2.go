// Translated from
// https://github.com/JoeyDeVries/LearnOpenGL/blob/master/src/1.getting_started/4.3.textures_exercise2/textures_exercise2.cpp
...
func main() {
	...
	ourShader := shader.MakeShaders("4.4.texture.vs", "4.4.texture.fs")
